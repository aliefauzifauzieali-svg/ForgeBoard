  ...
  return (
    ...
    >
      <div
        ...
        className={`flex max-h-[92dvh] w-full flex-col overflow-hidden rounded-t-3xl border border-zinc-200 bg-white shadow-pop dark:border-white/10 dark:bg-[#1A1A1E] sm:rounded-2xl ${
