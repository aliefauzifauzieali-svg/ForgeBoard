import { Home, KanbanSquare, Plus } from 'lucide-react';
      ...
      <div className="grid grid-cols-3">
        <button
          ...
          className={cn(
            ...
            view.kind === 'dashboard' ? 'text-indigo-600 dark:text-indigo-400' : 'text-zinc-500',
          )}
        >
        ...
        <button
          ...
          className={cn(
            ...
            view.kind === 'project' ? 'text-indigo-600 dark:text-indigo-400' : 'text-zinc-500',
          )}
        >
        ...
        <button
          ...
          className="flex flex-col items-center gap-1 py-2.5 text-[11px] font-semibold text-zinc-500"
        >
